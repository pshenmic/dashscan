...
export default class Address {
  ...
  constructor(address?: string, firstSeenBlock?: string, firstSeenTx?: string, lastSeenBlock?: string, lastSeenTx?: string) {
  ...
  static fromRow({ address, first_seen_block, first_seen_tx, last_seen_block, last_seen_tx }: AddressRow): Address {
    return new Address(address, first_seen_block, first_seen_tx, last_seen_block, last_seen_tx);
  }
}
