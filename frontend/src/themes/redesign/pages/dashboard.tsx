...
import { EmptyState } from "@/themes/redesign/components/empty-state";
import { HashDisplay } from "@/themes/redesign/components/hash-display";
import { LiveTicker } from "@/themes/redesign/components/live-ticker";
import {
  InstantLockBadge,
  MnStatusBadge,
  MnTypeBadge,
    ...
    >
      ...
      >
        ...
        {["p0", "p1", "p2"].map((id, i) => (
          <div
            key={id}
            className="chain-particle-html absolute top-1/2 size-1.5 -translate-y-1/2 rounded-full bg-accent"
