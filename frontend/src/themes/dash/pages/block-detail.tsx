...
import { DetailRow } from "@/themes/dash/components/detail-row";
...
import { SkeletonBar } from "@/themes/dash/components/skeleton";
import { TwoLineHash } from "@/themes/dash/components/two-line-hash";

interface ClassicBlockDetailPageProps {
  hashOrHeight: string;
}

export default function ClassicBlockDetailPage({
  hashOrHeight,
}: ClassicBlockDetailPageProps) {
