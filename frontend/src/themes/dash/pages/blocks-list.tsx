...
import { BlockTransactionsChart } from "@/themes/dash/components/block-transactions-chart";
...
interface ClassicBlocksListPageProps {
  page: number;
  limit: number;
}

export default function ClassicBlocksListPage({
  page,
  limit,
}: ClassicBlocksListPageProps) {
